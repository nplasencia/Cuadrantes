...
class DriverTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $drivers = [['Fernández Toribio','Marcial',680523539,2145,'2017-6-23','2021-6-28'],['Garcia Perez','Ana Maria',607846351,2106,'2016-6-2','2022-10-26'],['Garcia Macias','Blanca',690950144,2114,'2018-7-13','2022-10-15'],['Garcia Martin','Pedro Ramon',660332301,2158,'2019-6-3','2023-6-5'],['Dominguez De Leon','Jose',608939059,2133,'2016-6-2','2021-6-4'],['Rodriguez Madrona','Dolores',687842498,2148,'2020-8-28','2021-8-16'],['Soto Sanchez','Socorro',659417612,2163,'2016-6-2','2023-7-22'],['Toro  Alcaide','Jose Manuel',606357276,2135,'2019-6-27','2024-5-14'],['Santana Betancort','Margarita',699146792,2146,'2016-7-13','2020-10-6'],
                    ['Muñoz García','Aida',679643079,2140,'2019-8-27','2021-3-9', true],['Pedraza Roda','Gerardo',666336416,2124,'2019-6-9','2025-5-7'],['Peraza Martin','Antonio Juan',628538500,2108,'2016-6-2','2022-1-18'],['Regueira Fernandez','Eugenia',644353280,2121,'2017-6-23','2023-4-26'],['Valdivia Coaquira','Jules Isaldo',629962649,2141,'2020-8-28','2018-1-25'],['Lopez Herrera','Ricardo',660020277,2137,'2017-6-23','2020-2-25'],['Robayna De Leon','Jesús Orlando',609251722,2157,'2019-8-27','2021-3-3'],['Perez Valido','Alexi',601182098,2104,'2019-1-31','2025-8-16'],['Garcia Moreno','Antonio',685648851,2107,'2020-8-28','2022-11-24'],
