<div class="media user-media bg-dark dker">
    ...
    <div class="user-wrapper bg-dark">
        <a class="user-link" href="">
            <img class="media-object img-thumbnail user-img" alt="User Picture" src="{{ URL::asset('assets/img/user.gif') }}">
...
<ul id="menu" class="bg-dark dker">
    ...
    <li class="">
        ...
        <ul>
            ...
            <li>
                <a href="#">
                    <i class="fa fa-angle-right"></i>&nbsp; Descansos </a>
            </li>
            <li>
                <a href="#">
                    <i class="fa fa-angle-right"></i>&nbsp; Vacaciones </a>
            </li>
        </ul>
    </li>
    <li class="">
